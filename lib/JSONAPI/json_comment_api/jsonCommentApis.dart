...
class jsonCommentApis extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Json Comment Api'),
      ),
      body: Consumer<JsonCommentProvider>(
                        ...
                        children: [
                          ...
                          IconButton(
                            ...
                            onPressed: () async {
                              ...
                              titleController.text = post.name;
