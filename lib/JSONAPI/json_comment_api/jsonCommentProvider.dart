...
import 'jsonCommentDataModel.dart';
import 'dart:convert';


class JsonCommentProvider extends ChangeNotifier {
  List<Comment> _posts = [];

  List<Comment> get posts => _posts;
  ...
  Future<Comment> createPost(Comment comment) async {
    try {
      ...
      if (postResponse.statusCode == 201) {
        final newPost = Comment.fromJson(jsonDecode(postResponse.body));
